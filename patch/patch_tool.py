...
# this is a modified version of the Patcherex patch_master.py file
...
# change all the relative to absolute imports
...
from patcherex.networkrules import NetworkRules
...
# modify for testing 
# adding functions to test specific patches individually
...
class PatchMaster():
    ...
    def generate_medium_reassembler_optimized_binary(self,test_bin=True):
        try:
            ...
            patches.extend(NoFlagPrintfPatcher(intermediate, backend).get_patches())  # breaks???
    ...
    def generate_medium_reassembler_binary(self,test_bin=True):
        try:
            ...
            patches.extend(NoFlagPrintfPatcher(self.infile, backend).get_patches())  # breaks???
